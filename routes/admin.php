...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	//Reviews
	Route::get('/reviewsUpdate/{idp}/{idr}', 'ReviewController@updateReviews')->name('updateReviews.seller');
...
// product attribut :
	Route::resource('product_attribut','Product_attributeController');

// sellers bank account :
Route::get('bank_accounts/admin','bank_accountController@admin_bank_accounts')
			->name('bank_accounts.admin');

Route::get('bank_accounts/create','bank_accountController@admin_bank_accountsCreate')
			->name('bank_accounts_create.admin');

Route::post('bank_accounts/store','bank_accountController@store')
			->name('bank_accounts.store');

Route::get('bank_accounts/destroy/{id}','bank_accountController@destroy')
			->name('bank_accounts_destroy.admin');

Route::get('bank_accounts/edit/{id}','bank_accountController@edit')
			->name('bank_accounts.edit');

Route::POST('bank_accounts/update/{id}','bank_accountController@update')
