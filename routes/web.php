...
//bank_account
Route::get('/seller/bank_account', 'bank_accountController@index')->name('seller.bank_account');

Route::get('/bank_account/upload', 'HomeController@show_bank_account_upload_form')->name('seller.bank_accounts.upload');
Route::post('/bank_account/store/','bank_accountController@store')->name('banks_account.store');
Route::post('/bank_account/published','bank_accountController@updateStatut')
			->name('bank_accounts.published');

Route::get('/bank_accounts/destroy/{id}', 'bank_accountController@destroy')->name('bank_accounts.destroy');

Route::get('/bank_accounts/{id}/edit', 'HomeController@show_bank_account_edit_form')
			->name('seller.bank_accounts.edit');
