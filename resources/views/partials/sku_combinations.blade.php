	...
	@if(strlen($str) > 0)
			<tr>
				...
				<td>
					...
					<input type="file" name="photos2[]" id="{{ $sku }}" class="custom-input-file custom-input-file--4" data-multiple-caption="{count} files selected" accept="image/*" />
                   <label for="{{ $sku }}" class="mw-100 mb-3">
                       <span></span>
                       <strong>
