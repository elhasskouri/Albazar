                            ...
                            <form id="option-choice-form">
                                ...
                                @if (count(json_decode($product->colors)) > 0)
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-10">
                                            <ul class="list-inline checkbox-alphanumeric checkbox-alphanumeric--style-1 mb-2">
                                                @if(json_decode($product->Colors_Product))
                                                @foreach (json_decode($product->Colors_Product) as $key => $color)
                                                    <li>
                                                         <!-- 
                                                        <input class="xzoom"  type="radio" id="{{ $product->id }}-color-{{ $key }}" name="color" value="{{ $color }}" @if($key == 0) checked @endif>
                                                        
                                                        <label  style="background-image: url('{{asset( $color) }}');background-position: center; 
...
-->
                                    <div class="xzoom-thumbs">
                                            ...
                                            <a href="{{ asset( $color) }}">
                                                <img loading="lazy"  class="xzoom-gallery" width="50"
                                                height="50" src="{{ asset( $color)  }}"  @if($key == 0) xpreview="{{ asset( $color) }}" @endif>
                                            </a>
                            ...
                            <div class="row no-gutters mt-3">
                                ...
                                <div class="col-10">
                                    {{ substr($product->description, 0, $length = 100) }}
                            ...
                            <div class="row no-gutters mt-3">
                                <div class="col-2">
                                    <div class="product-description-label alpha-6">{{__('Weight')}}:</div>
                                </div>
                                <div class="col-10">
                            ...
                            <div class="row no-gutters mt-3">
                                <div class="col-2">
                                    <div class="product-description-label alpha-6">{{__('Dimenstions')}}:</div>
                                </div>
                                <div class="col-10">
                                    {{__('Length: ')}}{{ $product->length }}&nbspcm&nbsp&nbsp&nbsp
                                    {{__('Width: ')}}{{ $product->width }}&nbspcm
                                    &nbsp&nbsp&nbsp{{__('Height: ')}}{{ $product->height }}&nbspcm    
                                </div>
                            </div>
                            @endif
                             @foreach (json_decode($product->choice_options) as $key => $choic)
                             @if( $choic->title == 'Material' )  
                            @if($product->choice_options!=null)
                                <div class="row no-gutters mt-3">
                                <div class="col-2">
                                    <div class="product-description-label alpha-6">{{__('Material')}}:</div>
                                </div>
                                <div class="col-10">
                                    <ul class="inline-links">
                                        @foreach (json_decode($product->choice_options) as $key => $choice)
                                        @if($choice->title == 'Material')
                                        <li style="color: black;padding: 0px;" >
            ...
            <div class="row">
                <div class="col-xl-3 d-none d-xl-block">
                    <div class="seller-info-box mb-3">
                        <div class="sold-by position-relative" style="border: 0px">
                    ...
                    <div class="product-desc-tab bg-white">
                        <div class="tabs tabs--style-2">
                            <ul class="nav nav-tabs justify-content-center sticky-top bg-white">
                                ...
                                <li class="nav-item">
                                    <a href="#tab_default_5" data-toggle="tab" class="nav-link text-uppercase strong-600">{{__('Return Policy')}}</a>
                                </li>
                                            ...
                                            <div class="block block-comment">
                                                ...
                                                <div class="block-body">
                                                    <div class="block-body-inner">
                                                        ...
                                                        <form action="http://localhost:8000/admin/reviewsUpdate/{{$product->id}}/{{ $review->id }}" method="get">
                                                        <div class="form-group">
                                                             <div class="col-sm-13">
                                                                <textarea style="font-family: monospace;" name="comment" rows="8" class="form-control comment-text">
                                                                     {{ $review->comment }}
                                                                </textarea>
                                                             </div>
                                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="position-relative overflow-hidden h-100">
                                                ...
                                                <div class="product-btns">
                                                    ...
                                                    <button class="btn quick-view" title="Quick view" onclick=" ({{ $related_product->id }})">
                                                        <i class="la la-eye"></i>
                                                    </button>
                                                </div>
                                            </div>
