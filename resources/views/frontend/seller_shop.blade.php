            ...
            <div class="row">
                <div class="col-xl-3 d-none d-xl-block">
                    <div class="seller-info-box mb-3">
                        <div class="sold-by position-relative" style="border-bottom: 0px !important;">
                            @if($shop->user->seller->verification_status == 1)
                    ...
                    <div class="seller-top-products-box bg-white sidebar-box mb-4" style="visibility: hidden;">
