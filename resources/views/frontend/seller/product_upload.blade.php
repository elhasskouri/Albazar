                        ...
                        <form class="" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <input type="number" min="0" value="0" step="0.01" class="form-control mb-3" name="weight" placeholder="{{__('Weight')}}" >
                                        </div>
                                       
                                        <div class="col-3 col-md-2">
                                              <select class="form-control selectpicker" name="weight_type" data-minimum-results-for-search="Infinity">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <input type="number" min="0" value="" step="0.01" class="form-control mb-3" name="length" placeholder="{{__('L : 0.00 cm')}}" >
                                        </div>
                                       
                                        <div class="col-3">
                                            <input type="number" min="0" value="" step="0.01" class="form-control mb-3" name="width" placeholder="{{__('W : 0.00 cm')}}" required>
                                        </div>
                                        <div class="col-3">
                                            <input type="number" min="0" value="" step="0.01" class="form-control mb-3" name="height" placeholder="{{__('H : 0.00 cm')}}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row mb-3"><div class="col-8 col-md-3 order-1 order-md-0">
                                    <input type="text" class="form-control" value="{{__('Taille')}}" disabled>
                                        </div><div class="col-12 col-md-7 col-xl-8 order-3 order-md-0 mt-2 mt-md-0"><input type="text" class="form-control tagsInput" name="choice_options_'+i+'[]" placeholder="Enter choice values" onchange="update_sku()"></div></div>
