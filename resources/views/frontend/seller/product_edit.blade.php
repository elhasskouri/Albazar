                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <input type="number" min="0" value="{{ __($product->Weight) }}" step="0.01" class="form-control mb-3" name="weight" placeholder="{{__('Weight')}}" >
                                        </div>
                                      
                                        <div class="col-3 col-md-2">
                                              <select class="form-control selectpicker" name="weight_type" data-minimum-results-for-search="Infinity">
                                                    <option value="{{ __($product->weight_type) }}">{{ __($product->weight_type) }}</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <input type="number" min="0" value="{{ __($product->length) }}" step="0.01" class="form-control mb-3" name="length" placeholder="{{__('L : 0.00 cm')}}" >
                                        </div>
                                        
                                        <div class="col-3">
                                            <input type="number" min="" value="{{ __($product->width) }}" step="0.01" class="form-control mb-3" name="width" placeholder="{{__('W : 0.00 cm')}}" required>
                                        </div>
                                        <div class="col-3">
                                            <input type="number" min="0" value="{{ __($product->height) }}" step="0.01" class="form-control mb-3" name="height" placeholder="{{__('H : 0.00 cm')}}" required>
                                        </div>
