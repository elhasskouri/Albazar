                        ...
                        <div class="row">
                            <div class="col-md-3 col-6">
                                <div class="dashboard-widget text-center green-widget mt-4 c-pointer">
                                    <a href="http://localhost:8000/seller/products" class="d-block">
                            ...
                            <div class="col-md-3 col-6">
                                <div class="dashboard-widget text-center red-widget mt-4 c-pointer">
                                    <a href="http://localhost:8000/purchase_history" class="d-block">
                            ...
                            <div class="col-md-3 col-6">
                                <div class="dashboard-widget text-center blue-widget mt-4 c-pointer">
                                    <a href="http://localhost:8000/seller/payments" class="d-block">
