            ...
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-9">
                    <div class="main-content">
                        ...
                        <form class="" action="{{route('bank_account.update', $bankAccount->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            @csrf
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="" min="0" value="{{ __($bankAccount->userName) }}" step="0.01" class="form-control mb-3" name="name" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="" min="0" value="{{ __($bankAccount->bankAdresse) }}" step="0.01" class="form-control mb-3" name="bankAdresse" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-10">
                                            <div class="mb-3">
                                                <select class="form-control selectpicker" name="bank_name" data-minimum-results-for-search="Infinity">
                                                    <option value="{{ __($bankAccount->bankName) }}">{{ __($bankAccount->bankName) }}</option>

                                                    @foreach($banksName as $bankName)
                                                    <option value="{{ __($bankName) }}">{{ __($bankName) }}</option>
                                                    @endforeach
                                    ...
                                    <div class="row" id="quantity">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="" max="" value="{{ __($bankAccount->iBane) }}" step="1" class="form-control mb-3" name="iBane" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="row">
