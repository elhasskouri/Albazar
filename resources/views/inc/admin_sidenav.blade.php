...
<!---->
                        ...
                        <li class="{{ areActiveRoutes(['product_attribut.index'])}}">
                            <a class="nav-link" href="{{ route('product_attribut.index') }}">
                                <i class="fa fa-plus"></i>
                                <span class="menu-title">{{__('Product attribute')}}</span>
                            </a>
                        </li>
                        @endif
<!---->
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <!---->
                                <li class="{{ areActiveRoutes(['bank_accounts.admin'])}}">
                                    <a class="nav-link" href="{{ route('bank_accounts.admin') }}">{{__('Bank accounts')}}</a>
                                </li>
                            </ul>
                        </li>
                        @endif
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('4', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="{{ areActiveRoutes(['reviews'])}}">
